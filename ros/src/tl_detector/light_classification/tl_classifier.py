...
class TLClassifier(object):
    def __init__(self):
        ...
        #lotpath = './light_classification/model/frozen_inference_graph_lot.pb'
        #lotpath = './light_classification/model/frozen_inference_graph.pb'

        #lotpath = './light_classification/model/frozen_inference_graph_real.pb'
        #lotpath = './light_classification/model/frozen_inference_graph_sim.pb'



        # Best so far, but yellow interpreted as red
        #lotpath = './light_classification/model/frozen_15.pb'


        # POOR
        #lotpath = './light_classification/model/frozen_21.pb'

        # Poor
        #lotpath = './light_classification/model/frozen_2121.pb'   


        # Best so far, but yellow interpreted as red
        lotpath = './light_classification/model/frozen_1515.pb'  




        # Poor
        #lotpath = './light_classification/model/frozen_inference_real1.pb' 

        # Potential 1 with high probability, 2 with lower probability - alex
        #lotpath = './light_classification/model/frozen_all.pb'


        # Useless
        #lotpath = './light_classification/model/frozen_pri.pb'
        #lotpath = './light_classification/model/frozen_li.pb'
        #lotpath = './light_classification/model/frozen_ky.pb'
